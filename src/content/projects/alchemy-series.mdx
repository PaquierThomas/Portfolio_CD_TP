...
<ArticleShortTextBlock
  title={{
    highlightTitle: 'First ',
    secondPartTitle: 'inspiration',
  }}
  summary='It all begin when i made the battery animation tutorial of polygon runway. I then decided to make some projects with fluids and particles in blender.'
/>
<ArticleVideo
...
<ArticleShortTextBlock
  title={{
    highlightTitle: 'Alchemy ',
    secondPartTitle: 'as a primary subject ',
  }}
  summary='I quickly became drawn to alchemy as my subject, i really liked the colors and glowing effects the theme of alchemy has, so i decided to dive further in this subject while combining it with the first inspiration, which led me to embark on this next project.'
/>
...
<ArticleShortTextBlock
  title={{
    highlightTitle: 'Diving deep ',
    secondPartTitle: 'into the subject',
  }}
  summary='The two projects below presented the most significant challenges, pushing both me and my computer to the limit. I had to master the art of optimizing scenes and renders to overcome these hurdles. Despite my preparations, my computer ultimately struggled to handle the animations.'
/>
