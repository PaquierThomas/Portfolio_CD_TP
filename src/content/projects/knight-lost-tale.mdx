...
<ArticleShortTextBlock
  title={{
    highlightTitle: ' ',
    secondPartTitle: 'First Section',
  }}
  summary='The initial section sets the mood for players and gives them a glimpse of what to expect as they venture further into the level, game.'
/>
...
<ArticleShortTextBlock
  title={{
    highlightTitle: ' ',
    secondPartTitle: 'Crypt Section',
  }}
  summary='I wanted to give players a different vibe by taking them to a mysterious and intricate space, kind of like a crypt.'
/>
<ArticleImage
